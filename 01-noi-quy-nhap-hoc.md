...
> Bé Nam (15 tuổi, học sinh lớp 10) đăng ký học lập trình nhưng chưa có nền tảng tin học. Do độ tuổi lớp 10 quá chênh lệch với các bạn nhỏ Tầng 2 - Agent (học sinh lớp 6 - 8), trung tâm tư vấn Phụ huynh xếp bé vào lớp **FASTTRACK OD1 - 01 (Tầng đệm)**. Đây là lớp thiết kế riêng cho học viên lớn tuổi tiếp cận nhanh với lập trình và tư duy thuật toán độc lập, không học chung với Tầng 2 để giúp con thoải mái tâm lý và tiếp thu tốt nhất.
...
| Chương trình đào tạo | Quy mô gói Combo | Thời lượng thực học chuẩn | Thời hạn tối đa hoàn thành gói Combo |
| :--- | :--- | :--- | :--- |
| **Tầng 1 & Tầng 2** *(K1 đến K18)*<br>*(12 tuần học + 2 tuần Dự án cuối khóa = ~14 tuần/khóa)* | **Combo 3 Khóa** *(Ví dụ: K1-K3 hoặc K10-K12)* | ~42 tuần | **15 tháng** (~1 năm 3 tháng) |
| | **Combo 6 Khóa** *(Ví dụ: K1-K6 hoặc K10-K15)* | ~84 tuần | **31 tháng** (~2 năm 7 tháng) |
| | **Combo 9 Khóa** *(Trọn Tầng 1 hoặc Tầng 2)* | ~126 tuần | **48 tháng** (~4 năm) |
| **Tầng đệm & Tầng 3** *(OD1 & K19-K27)*<br>*(14 tuần học + 3 tuần Dự án cuối khóa = ~17 tuần/khóa)* | **Combo 2 Khóa** | ~34 tuần | **36 tuần** *(Đệm 2 tuần)* |
| | **Combo 4 Khóa** | ~68 tuần | **72 tuần** *(Đệm 4 tuần)* |
| | **Combo 8 Khóa** *(Trọn tầng)* | ~136 tuần | **142 tuần** *(Đệm 6 tuần)* |
...
> Học viên đang học lớp **AGENT K10 - 01** (sáng Thứ Bảy) đến buổi thứ 4 thì bị trùng lịch học đội tuyển tại trường. Phụ huynh báo Giáo vụ hỗ trợ chuyển sang lớp **AGENT K10 - 02** (chiều Chủ Nhật). Do lớp chưa quá 50% số buổi và có sự tương đồng về tiến độ, Giáo vụ tiến hành điều chuyển ngay trong tuần mà không mất phí.
...
> Học viên xuất sắc hoàn thành lớp **JUNIOR K1 - 01** với điểm Dự án cuối khóa 95/100 và đạt 92% bài kiểm tra phân loại. Hội đồng Học vụ xét duyệt cho con nhảy cóc qua Khóa K2 để vào thẳng lớp **JUNIOR K3 - 01**. Phụ huynh chỉ cần thanh toán phần chênh lệch học phí giữa K3 và K2 (nếu có theo biểu phí ban hành).
...
* **5.3. Văn hóa ứng xử & Kỷ luật phân tầng:**
  * Tôn trọng mọi người. Cấm gian lận mã nguồn, nói tục, phá hoại tài sản.
  * **Nghiêm cấm bắt nạt học đường (Cyberbullying):** Tuyệt đối không cô lập, chê bai sản phẩm code của bạn bè trên không gian mạng và tại lớp.
  * **Quy trình kỷ luật 3 bước:** Nhắc nhở riêng lần 1 ➔ Cảnh cáo văn bản & báo Phụ huynh lần 2 ➔ Đình chỉ học/Buộc thôi học không hoàn phí lần 3.
* **5.4. An toàn:** CyberSoft không chịu trách nhiệm quản lý Học viên ngoài giờ học chính thức.

> **Ví dụ Kỷ luật lớp học (Điều 5):**  
> Trong giờ học lớp **AGENT K11 - 01**, học viên lén mở tab chơi game web và bình luận chê bai sản phẩm Dự án cuối khóa của bạn cùng bàn trên nhóm chat lớp. Giảng viên thực hiện:  
...
> **Ví dụ Học bù Tutor (Điều 6):**  
> Học viên lớp **JUNIOR K1 - 01** bị sốt xuất huyết phải nghỉ buổi 5 và buổi 6 (Phụ huynh có nhắn tin báo Giáo vụ trước ca học 3 tiếng). Sau khi học viên bình phục, Giáo vụ sắp xếp 01 buổi Tutor 1:1 trong 45 phút vào tối Thứ Năm với Mentor để tóm tắt các khối lệnh vòng lặp và điều kiện, giúp con theo kịp buổi 7 vào cuối tuần.
...
> **Ví dụ Liêm chính học thuật (Điều 7):**  
> Trong buổi Demo Day lớp **AGENT K10 - 01**, học viên nộp sản phẩm game bắn máy bay phức tạp nhưng không giải thích được cơ chế hoạt động của hàm (Function) do lấy code của anh trai. Giảng viên sẽ yêu cầu học viên làm lại một mini-project độc lập dựa trên đúng năng lực thực tế của mình để chấm điểm lại.
...
> Học viên theo học lớp **AGENT K10 - 01**, đi học đủ 14/14 buổi, nộp bài tập đầy đủ nhưng thi Dự án cuối khóa chỉ đạt 54/100 điểm do còn yếu phần mảng (List) và từ điển (Dictionary). Nhờ tính chuyên cần cao, CyberSoft cấp suất **Học lại MIỄN PHÍ 100%** cho con ở lớp K10 khai giảng tháng sau.
...
* **11.3. Thời hạn sử dụng và Thu hồi tài khoản:**
  * **Điều kiện duy trì:** Hệ thống Tài khoản LMS và quyền lợi chỉ có hiệu lực khi khách hàng đang là Học viên chính thức.
  * **Đối với Học viên hoàn thành khóa học:**
    * **Tài khoản LMS CyberSoft:** Tự động thu hồi sau **01 tuần (07 ngày)** kể từ ngày bế giảng khóa học. Học viên chủ động tải toàn bộ code dự án về máy cá nhân trong 7 ngày này.
    * **Tài khoản Giá trị tăng thêm:** Duy trì theo thời hạn gói đăng ký (Ví dụ: Combo 1 năm ➔ duy trì quyền lợi 2 năm).

> **Ví dụ Thu hồi tài khoản LMS (Điều 11):**  
> Lớp **JUNIOR K1 - 01** bế giảng vào ngày 10/10. Tài khoản LMS của học viên sẽ duy trì đăng nhập đến hết ngày 17/10. Sau ngày 17/10, hệ thống tự động ngắt truy cập khóa K1. Khi học viên đăng ký tiếp khóa **JUNIOR K2 - 01**, tài khoản sẽ được kích hoạt lại cho khóa K2.
...
> **Ví dụ Đền bù thiết bị (Điều 13):**  
> Học viên trong giờ học Robotics lớp **JUNIOR K4 - 01** dùng lực bẻ gãy thanh nối motor VEX trái với hướng dẫn kỹ thuật của Giảng viên. Trung tâm lập biên bản kỹ thuật có chữ ký xác nhận của Giảng viên và gửi Phụ huynh để đối chiếu chi phí thay thế linh kiện theo giá niêm yết của hãng.
...
* **16.1. Kênh tiếp nhận chính thức:** Mọi phản ánh, ý kiến đóng góp hoặc khiếu nại của Phụ huynh chỉ được xử lý thông qua 3 kênh chính thức:
  * Hotline Chăm Sóc Khách Hàng CyberSoft
