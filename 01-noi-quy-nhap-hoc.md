...
| Chương trình đào tạo | Quy mô gói Combo | Thời lượng thực học (Chuẩn 1 buổi/tuần) | Thời hạn tối đa hoàn thành gói Combo |
| :--- | :--- | :--- | :--- |
| **Tầng 1 & Tầng 2** *(K1 đến K18)*<br>*(Mỗi khóa ~14 tuần)* | **Combo 3 Khóa** *(Ví dụ: K1-K3 hoặc K10-K12)* | ~42 tuần | **15 tháng** (~1 năm 3 tháng) |
...
| **Tuần đệm & Tầng 3** *(OD1 & K19-K27)*<br>*(Mỗi khóa ~17 tuần)* | **Combo 2 Khóa** | ~34 tuần | **36 tuần** *(Đệm 2 tuần)* |
| | **Combo 4 Khóa** | ~68 tuần | **72 tuần** *(Đệm 4 tuần)* |
| | **Combo 8 Khóa** *(Trọn Tầng 3)* | ~136 tuần | **142 tuần** *(Đệm 6 tuần)* |
...
> Học viên đăng ký lớp **Khóa K1 (Scratch Basic)**. Sau 2 buổi đầu, Giảng viên nhận thấy học viên đã tự học Scratch rất thành thạo và giải bài tập cực nhanh. Trung tâm chủ động chuyển học viên lên lớp **Khóa K2 (Scratch Nâng cao)** và **miễn trừ 100% phần học phí chênh lệch** của khóa học đó.
...
> Trong buổi Demo Day **Khóa K10 (Python Basic)**, học viên nộp sản phẩm game bắn máy bay phức tạp nhưng không giải thích được cơ chế hoạt động của hàm (Function) do lấy code của anh trai. Giảng viên sẽ yêu cầu học viên làm lại một mini-project độc lập dựa trên đúng năng lực thực tế của mình để chấm điểm lại.
...
> Học viên theo học lớp **K10 (Python Basic)**, đi học đủ 14/14 buổi, nộp bài tập đầy đủ nhưng thi Đồ án chỉ đạt 54/100 điểm do còn yếu phần mảng (List) và từ điển (Dictionary). Nhờ tính chuyên cần cao, CyberSoft cấp suất **Học lại MIỄN PHÍ 100%** cho con ở lớp K10 khai giảng tháng sau.
...
* **10.3. Quyền của Học viên:** Bản quyền mã nguồn và ý tưởng Đồ án cuối khóa do học viên tự sáng tạo thuộc về cá nhân Học viên/Phụ huynh. CyberSoft chỉ giữ quyền lưu trữ hồ sơ năng lực (Portfolio).
...
* **11.3. Thời hạn sử dụng và Thu hồi tài khoản:**
  ...
  * **Đối với Học viên hoàn thành khóa học:**
    * **Tài khoản LMS CyberSoft:** Tự động thu hồi sau **01 tuần (07 ngày)** kể từ ngày bế giảng khóa học. Học viên chủ động tải toàn bộ code đồ án về máy cá nhân trong 7 ngày này.
...
> Lớp **K1 (Scratch Basic)** bế giảng vào ngày 10/10. Tài khoản LMS của học viên sẽ duy trì đăng nhập đến hết ngày 17/10. Sau ngày 17/10, hệ thống tự động ngắt truy cập khóa K1. Khi học viên đăng ký tiếp khóa **K2**, tài khoản sẽ được kích hoạt lại cho khóa K2.
...
> Học viên trong giờ học Robotics dùng lực bẻ gãy thanh nối motor VEX trái với hướng dẫn kỹ thuật của Giảng viên. Trung tâm lập biên bản kỹ thuật có chữ ký xác nhận của Giảng viên và gửi Phụ huynh để đối chiếu chi phí thay thế linh kiện theo giá niêm yết của hãng.

---

### 14. QUY CHUẨN MÔ HÌNH HỌC TRỰC TUYẾN (ONLINE)
* **14.1. Hiện diện:** Bắt buộc bật Camera suốt buổi học, đổi tên hiển thị theo cú pháp: `[Mã Lớp] - [Họ tên Học viên]` (Ví dụ: `K10-ONL1 - Nguyễn Văn An`).
...
> Bố mẹ bận đột xuất nên đặt xe GrabCar đón bé sau ca học lớp **K1-OFF**. Mẹ nhắn tin vào nhóm Zalo lớp: *"Thầy cô ơi, mẹ bận nên có đặt xe GrabCar biển số 51H-999.88, tài xế tên Trần Văn C đến đón bé An giúp mẹ nhé"*. Giáo vụ đối chiếu đúng tên tài xế và biển số xe rồi mới dắt bé ra cổng bàn giao cho bác tài.